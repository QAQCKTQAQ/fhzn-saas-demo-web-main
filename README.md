...
🚀🚀🚀 fhzn-saas-web，前端基于 React18、React-Router v6、React-Hooks、Redux 、TypeScript、Vite4、Ant-Design4.X；集成了基于 Koa2 实现的 BFF 层（首页服务端渲染、鉴权、接口转发）等功能的一套后台管理框架。

### 二、🔨🔨🔨 项目功能

- 🚀 采用最新技术找开发：React18、React-Router v6、React-Hooks、TypeScript、Vite2、Koa2、Koa-Router
...
- 🚀 使用 Koa2 生态实现 BFF 层，支持首次服务端渲染、接口转发/整合、后续自定中间件等
...
```text
git clone git@gitlab.fhzny.com:web/fhzn-saas-web.git
...
├─ server                 # BFF代码目录
│	 ├─ config              # BFF - 配置文件
│	 ├─ controllers         # BFF - Koa2控制器
│	 ├─ routers             # BFF - 路由
│	 ├─ service             # BFF - 具体接口请求实现
│	 ├─ uitls               # BFF - 工具
│	 ├─ app.js              # BFF - 入口文件
│	 ├─ index.js            # BFF - 启动文件
├─ src
