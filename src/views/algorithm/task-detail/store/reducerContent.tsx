 ...
 * @LastEditTime: 2023-10-13 14:31:48
 */
...
export function ReducerContent(props: any) {
	...
	const getDetailData = async (id: any) => {
		...
		if (modelVersion && modelId) {
			resModel = await getModeltDetailApi(modelId, modelVersion)
		}
		const resIndicatorsDetails = await getTestIndicatorsApi(id)
