...
import { DD_LIST, initialState, reducer, SELECT_DD_ID, SELECT_TIME, ZZ_CG_ACTIVE } from './index'
...
export function ReducerContent(props: any) {
	...
	return <Context.Provider value={{ state, setSelectDdId, testId, setZzCgActive }}>{props.children}</Context.Provider>
}
