...
import { DD_LIST, initialState, reducer, SELECT_DD_ID, SELECT_TIME, CHANGE_SELECT_TIME } from './index'
...
export function ReducerContent(props: any) {
	...
	const setChangeSelectTime = (changeSelectTime: any) => {
		dispatch({ type: CHANGE_SELECT_TIME, changeSelectTime })
	}
	...
	return <Context.Provider value={{ state, setSelectDdId, testId, setChangeSelectTime }}>{props.children}</Context.Provider>
}
