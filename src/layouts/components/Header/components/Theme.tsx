...
const Theme = (props: any) => {
	...
	const { weakOrGray, breadcrumb, footer } = themeConfig
	...
	// 切换模式
	const onMenuChange = (menuMode: string) => {
		setThemeConfig({ ...themeConfig, menuMode })
	}
			...
			>
				...
				<div className="theme-item">
					...
					<Switch
						checkedChildren="横"
						unCheckedChildren="纵"
						checked={themeConfig.menuMode === 'ROW' ? true : false}
						onChange={e => {
							const menuMode = e ? 'ROW' : 'COL'
							onMenuChange(menuMode)
						}}
					/>
				</div>
				<br />
